                            ...
                            <Stack direction="horizontal" gap={2}>
                                ...
                                <Button variant="outline-success"
                                    onClick={() => {
                                        ...
                                        const calendar = document.getElementsByClassName("inForm")
                                        calendar[0].children[1].style.display = "none"
                                        //     em[0].children[0].classList.add('d-none')
                                        printwin.document.write(document.getElementById("printform").outerHTML);
                                        printwin.print();
                                        calendar[0].children[1].style.display = ""
                                    }}>พิมพ์</Button>
                            </Stack>
                        </div>
